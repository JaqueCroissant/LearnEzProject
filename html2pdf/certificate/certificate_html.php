...
$html = '<html>
        ...
        <body>
            ...
            <div style="width:100%;">
                <div class="date_awarded_text"><div>'. TranslationHandler::get_static_text("CERTIFICATE_ASSIGNED_DATE") .':</div><div style="margin-top:-5px;font-size:26px;">26-07-2015</div></div>
