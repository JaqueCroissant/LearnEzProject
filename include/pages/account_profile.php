...
<div class="profile-header" style="margin: -1.5rem -1.5rem 1.5rem -1.5rem !important;">
    ...
    <div class="profile-cover">
        ...
        <div class="text-center">
            <h4 class="profile-info-name m-b-lg"><span class="title-color"><?= format_first_last_name($current_user->firstname, $current_user->surname, 50); ?></span></h4>
            ...
            <div class="panel-body user-information">
                <table class="profile_information_table">
                    <tr>
                        ...
                        <td style="text-align:right;"><?= format_first_last_name($current_user->firstname, $current_user->surname, 22) ?></td>
                    </tr>
                    <tr>
                                ...
                                <div class="panel-body">
                                    ...
                                    if (is_array($achievementHandler->not_achieved) && array_key_exists($i, $achievementHandler->not_achieved)) {
                                        foreach ($achievementHandler->not_achieved[$i] as $val) {
                                            $j++;
                                            ?>
                                    <div class="col-md-3 col-sm-6 p-h-lg p-b-xl m-h-md achievement_display" style="opacity: 0.65;">
