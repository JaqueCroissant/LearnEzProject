...
<?php } ?>
<?php
if ($userHandler->_user->user_type_id == "1" || $userHandler->_user->user_type_id == "2") {
...
<?php } ?>
<?php if ($userHandler->_user->user_type_id == "2" || $userHandler->_user->user_type_id == "3") { ?>
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                    $homeworkHandler->get_specific_user_homework($current_user->id);
                    if (empty($homeworkHandler->homework)) {
                        ?>
                        <div class="center latest-homework-empty m-h-md"><?php echo TranslationHandler::get_static_text("USER_NO_HOMEWORK_AT_THE_MOMENT"); ?></div>
                    <?php } else { ?>
