                                        ...
                                        <div class="form-group m-b-sm">
                                            ...
                                            <select id="sort_order" name="sort_order" class="form-control" data-options="{minimumResultsForSearch: Infinity}" data-plugin="select2">
                                                ...
                                                for($i = 0; $i < count($courseHandler->courses); $i++) {
                                                    ...
                                                    echo '<option value="'.$courseHandler->courses[$i]->sort_order.'" '. (array_key_exists(($i+1), $courseHandler->courses) && $courseHandler->courses[($i+1)]->id == $courseHandler->current_element->id ? 'selected' : '') .'>'.$courseHandler->courses[$i]->title.'</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 16px !important;">
                                        ...
                                        <div class="form-group m-b-sm">
                                            ...
                                            <select id="course_id" name="course_id" class="form-control add_lectures" data-options="{minimumResultsForSearch: Infinity}" data-plugin="select2">
                                                ...
                                                foreach($courseHandler->courses as $course) {
                                                    echo '<option value="'.$course->id.'" '. ($courseHandler->current_element->course_id == $course->id ? 'selected' : '') .'>'.$course->title.'</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            for($i = 0; $i < count($courseHandler->lectures); $i++) {
                                                ...
                                                $select_boxes .= '<option value="'.$courseHandler->lectures[$i]->sort_order.'" '. (array_key_exists(($i+1), $courseHandler->lectures) && $courseHandler->lectures[($i+1)]->id == $courseHandler->current_element->id ? 'selected' : '') .'>'.$courseHandler->lectures[$i]->title.'</option>';
                                            }
                                        ?>
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 16px !important;">
                                        ...
                                        <?php
                                            ...
                                            for($i = 0; $i < count($courseHandler->tests); $i++) {
                                                ...
                                                $select_boxes .= '<option value="'.$courseHandler->tests[$i]->sort_order.'" '. (array_key_exists(($i+1), $courseHandler->tests) && $courseHandler->tests[($i+1)]->id == $courseHandler->current_element->id ? 'selected' : '') .'>'.$courseHandler->tests[$i]->title.'</option>';
                                            }
                                        ?>
