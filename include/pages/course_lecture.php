...
<div class="test_content">
    <div class="course_bar widget" style="<?php echo "background-color: " . htmlspecialchars($courseHandler->current_element->course_color) . " !important;width:95%;max-width:1024px;" ?>">      
