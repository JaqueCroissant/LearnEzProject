                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="padding: 0px 20px;">
                                        <div class="pieprogress text-primary circle_progress" style="width:80px !important;" data-plugin="circleProgress" data-value="<?= $value->overall_progress/100 ?>" data-thickness="9" data-size="100" data-start-angle="90" data-empty-fill="rgba(0, 0, 0, .2)" data-fill="{&quot;color&quot;: &quot;<?= get_progress_color($value->overall_progress); ?>&quot;}">
                                            <strong style="color: #6a6c6f !important;margin-top: -14px;font-size: 16px" ><div data-plugin="counterUp" style="display:inline-block"><?= $value->overall_progress ?></div><div style="display:inline-block">%</div></strong>
                                        </div>
                                    </td>
                                </tr>
                            </table>
