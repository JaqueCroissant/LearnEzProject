        ...
        <div class="col-md-12">
            ...
            <div style="border-top: 8px solid <?php echo $courseHandler->current_element->color; ?>;background: none !important; ">
                <div class="panel-body" style="background: none !important; padding: 16px 0px !important; ">
                    ...
                    <?php } else { ?>
                    <div class="col-md-12">
                        <div class="widget" style="cursor:pointer;" data-container="body" data-toggle="popover" data-delay='{"show":"300", "hide":"300"}' data-placement="top" data-trigger="hover" data-content="<?= $value->description; ?>">
                            <div class="widget-body">
                                <?php echo $value->is_complete ? '<div class="ribbon" style="zoom: 0.8;-moz-transform: scale(0.8);right:10px !important;"><span>'. TranslationHandler::get_static_text("COMPLETED") .'</span></div>' : ''; ?>
                                <div class="clearfix">
                                    <table style="width:100%;">
                                        <tr>
                                            <td style="padding-top:4px !important;"><div class="pieprogress text-primary circle_progress" data-plugin="circleProgress" data-value="<?= $value->percent_progress/100 ?>" data-thickness="6" data-size="20" data-start-angle="90" data-empty-fill="rgba(0, 0, 0, .2)" data-fill="{&quot;color&quot;: &quot;<?= get_progress_color($value->percent_progress); ?>&quot;}" style="float:left;"></div><div data-plugin="counterUp" style="float:left;padding-left:10px;"><?= $value->percent_progress ?></div><div style="float:left;">%</div></td>
                                            <td></td>
                                            <td><?= $value->title; ?></td>
                                            <td style="text-align:right;padding-left:20px;"><small class="text-color"><?= TranslationHandler::get_static_text("POINT_AMOUNT"); ?>:</small><small class="text-color" style="padding-left:10px;"><?= $value->points; ?></small></td>
                                            <td style="text-align:right;width:20%;padding-left:20px;"><small class="text-color"><?= TranslationHandler::get_static_text("DIFFICULTY"); ?>:</small><small class="text-color" style="padding-left:10px;"><?php echo  $value->advanced ? TranslationHandler::get_static_text("EASY") : TranslationHandler::get_static_text("HARD")  ?></small></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
