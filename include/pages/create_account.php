								...
								<div class"widget">
                                    ...
                                    <form method="POST" action="" id="create_single" url="create_account.php?step=1" name="create_single_user">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="select1" name="class_name" class="form-control input-sm" data-plugin="select2">

                                                    <?php
                                                        //$schoolHandler->get_all_schools();
                                                        foreach($schoolHandler->all_schools as $school)
                                                        {
                                                            echo '<option value = "' . $school->id . '">' . $school->name . ', ' . $school->adress . '</option>';
                                                        }
                                                    ?>
                    ...
                    <form method="POST" action="" id="create_single" url="create_account.php?step=1" name="create_single_user">
                        <table style="width: 30%;">
                            ...
                            <tr>
                                ...
                                <td class="right-col">
                                    <?php
                                        if($userHandler->_user->user_type_id==1)
                                        {
                                            echo '<input type="text" id="school" name="school_name" placeholder="' . TranslationHandler::get_static_text("SCHOOL_NAME") . '"><br/>';
                                        }
                                    ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="right-col">
                                    <input type="text" id="class" name="class_name" placeholder="<?php echo TranslationHandler::get_static_text("CLASS_NAME"); ?>"><br/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <input type="button" id="submit_button" name="submit" value="<?php echo TranslationHandler::get_static_text("CREATE_SUBMIT"); ?>" class="create_submit_info">
                                </td>
                            </tr>
                        </table>
                    </form>
