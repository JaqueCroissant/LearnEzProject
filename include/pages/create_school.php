...
<div class="col-md-12">
    <div class="widget">
        ...
        <div class="widget-body">
            <div id="step_one">
                <form method="post" id="create_class" action="" class="form-horizontal" url="create_school.php">
            ...
            <div id="step_two" class="hidden">
                <form method="POST" id="create_school_step_two" class="form-horizontal" action="" url="create_school.php">
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-offset-2 control-label" for="school_max_students"><?php echo TranslationHandler::get_static_text("SCHOOL_MAX_STUDENTS"); ?></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group" >
                        <label class="col-sm-2 col-sm-offset-2 control-label" for="school_subscription_end"><?php echo TranslationHandler::get_static_text("SCHOOL_SUBSCRIPTION_END"); ?></label>
                        <div class="col-md-5">
