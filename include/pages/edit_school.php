                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="m-b-sm">
                                    ...
                                    <div class="row">
                                        <input class="form-control col-sm-3" id="edit_school_zip_code" type="text" name="school_zip_code" placeholder="<?php echo TranslationHandler::get_static_text("ZIP_CODE"); ?>" value="<?php echo isset($_GET['school_id']) ? $schoolHandler->school->zip_code : ""; ?>">
                                        <input class="form-control col-sm-9" id="edit_school_city" type="text" name="school_city" placeholder="<?php echo TranslationHandler::get_static_text("CITY"); ?>" value="<?php echo isset($_GET['school_id']) ? $schoolHandler->school->city : ""; ?>">
                                    </div>
                                </div>
                                <div class="m-b-sm">
