        ...
        <div class="app-action-panel" id="inbox-action-panel">
            ...
            <div class="app-actions-list scrollable-container ps-container ps-theme-default" data-ps-id="0ba7452c-1106-b6f8-5070-56e24cb65638">
                <div class="list-group">
                    <a href='javascript:void(0)' class='change_page text-color list-group-item' page='notifications' step='' id='notifications'><i class='m-r-sm fa fa-bookmark'></i><?php echo TranslationHandler::get_static_text("ALL") ?></a>
                    <?php
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="btn-group m-b-lg">
                    <a href="javascript:void(0)" class="assign_mail_folder btn btn-default" title="<?php echo TranslationHandler::get_static_text("DELETE_CHOSEN") ?>"><i class="fa fa-trash"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <td>
                                    <?php
                                        ...
                                        if (isset($current_page)) {
                                            $not_handler->load_notifications_from_category($not_handler->_user->id, 0, $current_page, 5);
                                            $notifs = $not_handler->get_notifications();
                                        }
                                        else{
                                            $not_handler->load_notifications($not_handler->_user->id, 0, 5);
                                            $notifs = $not_handler->get_notifications();
                                        }
                                        if (count($notifs) > 0) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mail-center">
                                                                <div class="mail-item-header">
                                                                    ...
                                                                    <span class="label ' . $notif->label . '">' . $notif->category . '</span>
                                                                </div>
