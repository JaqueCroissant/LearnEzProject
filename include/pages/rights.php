        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="m-b-lg nav-tabs-horizontal">
                    <ul class="nav nav-tabs" role="tablist" style="float:left;width:95%;">
                                            ...
                                            <div style="display: inline-block; vertical-align: top; min-width:230px;">
                                                <ul class="treeview">
                                                    ...
                                                    foreach ($ordered_pages as $page) {
                                                        ...
                                                        if (empty($last_page_subpage_level) && $counter > 12) {
                ...
                <div class="m-b-lg nav-tabs-horizontal">
                    ...
                    <div class="my_tab_content p-md">
                        ...
                        for ($i = 1; $i < 5; $i++) {
                            ...
                            <div class="my_fade my_tab" id="tab-<?php echo $i; ?>">
                                <?php
                                if ($pageHandler->get_page_rights($i, true) && $rightsHandler->get_user_type_rights($i, true)) {
                                    ?>
                                    ...
                                    <div class="widget-body">
                                        <form method="POST" action="" id="page_rights_form_<?php echo $i; ?>" url="rights.php" class="" name="rights">
                                            <input type="hidden" name="user_type_id" value="<?php echo $i; ?>">
                                            <input type="hidden" name="closed_users" value="1">
                                            <div style="display: inline-block; vertical-align: top; min-width:230px;">
                                                <ul class="treeview">
                                                    <?php
                                                    $counter = 0;
...
$(document).ready(function(){
    ...
    var height = $(".nav-tabs").height();
    $(".change_type").height($(".nav-tabs").height());
    $(".zmdi-refresh-alt").css("padding", (height-$(".zmdi-refresh-alt").height()) / 2 + "px 0px");
});
</script>