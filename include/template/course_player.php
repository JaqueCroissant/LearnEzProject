        ...
        <div class="course_bar primary course_window_test">      
            ...
            <div class="course_lecture_menu" style="display:none;">
                ...
                <div class="btn-group pull-right course_navigation">
                    ...
                    <a href="javascript:void(0)" value="continue" class="course_action course_lecture_button course_continue btn btn-default" data-toggle="tooltip" data-container="#iframe_content" data-trigger="hover" data-placement="bottom" title=<?php echo TranslationHandler::get_static_text("CONTINUE") ?>><i class="zmdi zmdi-skip-next"></i></a>
                </div>
            </div>
