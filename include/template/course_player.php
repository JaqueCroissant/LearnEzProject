<?php if ($loginHandler->check_login()) { ?>
    <div class="course_return cursor">
        <div class="center p-l-sm p-r-sm">
            <i class="fa fa-chevron-up m-r-sm"></i>
            <span class="course_player_test_title"></span>
            <i class="course_return_icon zmdi zmdi-graduation-cap m-l-sm"></i>
        </div>
    </div>
